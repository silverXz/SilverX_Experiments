...
void GLSLProgram::setMaterial(vec3 Ka,vec3 Kd, vec3 Ks,float shininess)
{
	setUniform("material.Ka", Ka);    //ambient
	setUniform("material.Kd", Kd);    //diffuse   
	setUniform("material.Ks", Ks);   //specular
