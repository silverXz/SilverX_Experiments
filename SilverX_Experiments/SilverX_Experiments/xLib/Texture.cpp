...
int CTexture::ReadFile(char *filename, unsigned int width,
...
int CTexture::ReadFileRAW(char *filename, unsigned int width,
						  unsigned int height, unsigned int depth)						
{
...
void CTexture::Color(unsigned int x, unsigned int y, unsigned char *pRed,
